        ...
        <body>
            ...
            <script>
                ...
                function addMoreDistance() {
                    ...
                    input2.type = 'text';
                    input2.name = 'distance_to_point1';
